    ...
    <footer class="bg-gray-900" aria-labelledby="footer-heading">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <div class="space-y-8">
                    <img class="h-7" src="~/assets/icon.png" alt="Personas" />
            ...
            <div class="mt-8 border-t border-gray-900/10 pt-3 sm:mt-10 lg:mt-12">
                <p class="text-xs leading-5 text-gray-500">&copy; 2024 <NuxtLink to="https://modenero.com" target="_blank" class="text-blue-300 hover:underline">Modenero DAO</NuxtLink>. All rights reserved.</p>
            </div>
        </div>
    </footer>
</template>
